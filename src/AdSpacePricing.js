    ...
    <Card>
      <CardContent>
        ...
        <Typography gutterBottom>
          Add the base price for the ad space. This provides a baseline for
          advertisers to browse through. The final price will be managed on the
          review process.
        </Typography>
        <Alert severity="info" sx={{ typography: "body2" }}>
          <AlertTitle>How to add price</AlertTitle>
          If the cost of an ad is $1200 for 30 seconds, Price: 1200, unit: 30,
          metric: sec(s)
        </Alert>
        <Box component="form" onSubmit={handleSubmit(onSubmit)}>
          ...
          <Box mt={2}>
            <Button
              variant="outlined"
              startIcon={<Add />}
              onClick={() => append({ value: "", unit: "", metric: "" })}
            >
          ...
          <Grid container spacing={2} sx={{ mt: 2 }}>
            <Grid item xs={12} md={2}>
              <Button onClick={() => setTab('media')}>Go back</Button>
            </Grid>
